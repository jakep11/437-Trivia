...
router.get('/:id', function(req, res) {
   ...
   if (vld.checkPrsOK(req.params.id)) {
      req.cnn.query('select Person.id, firstName, lastName, email,' +
       ' count(personId) as points, UNIX_TIMESTAMP(whenRegistered) * 1000 as' +
       ' whenRegistered, UNIX_TIMESTAMP(termsAccepted) * 1000 as termsAccepted,' +
